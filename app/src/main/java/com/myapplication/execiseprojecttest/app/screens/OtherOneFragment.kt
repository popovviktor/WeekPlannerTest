 ...
 * Use the [OtherOneFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OtherOneFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OtherOneFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OtherOneFragment().apply {
