 ...
 * Use the [OtherTwoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OtherTwoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OtherTwoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OtherTwoFragment().apply {
